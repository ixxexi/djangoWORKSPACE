...
class PModel(models.Model):
	maker = models.ForeignKey(Maker, on_delete=models.SET_DEFAULT, default = 3)
...
class Product(models.Model):
	pmodel = models.ForeignKey(PModel, on_delete=models.SET_DEFAULT, default = 4, verbose_name = '型號')
